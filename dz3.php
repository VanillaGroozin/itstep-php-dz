...
$validationScheme = [
   ...
   */
  "title" => [
    "clear-extra-spaces" => sTrim($form['title']), 
    "require" => $form['title'] ? '' : 'Обязательное поле',
  ],
   ...
   */
  "author" =>  [
    "clear-extra-spaces"  => sTrim($form['author']), 
    "require" => $form['author'] ? '' : 'Обязательное поле',
    "upperfirst" => upperFirst($form['author'])
  ],
   ...
   */
  "isbn" => [
    "clear-extra-spaces"  => sTrim($form['isbn']),
